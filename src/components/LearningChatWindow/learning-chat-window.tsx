...
import { getLearningFeedPrompt } from "~/server/prompt/prompt";

function LearningChatWindow({
  nativeLanguage,
  targetLanguage,
}: {
  ...
  const chatPropmt = getLearningFeedPrompt(sceneId,userScene,characterId,targetLanguage,nativeLanguage);
...
export default LearningChatWindow;
