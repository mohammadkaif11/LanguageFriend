...
import { uid } from "uid";
function Chat({ title, description }: { title: string; description: string }) {
  ...
  return (
    <div className="relative mt-6 flex max-w-[500px]  flex-col rounded-xl bg-yellow-100 bg-clip-border text-gray-700 shadow-md md:h-[180px] ">
      <div className="p-4">
        <img
        ...
        <div className="float-right flex pr-2 pt-2">
          <button
            onClick={handleChat}
